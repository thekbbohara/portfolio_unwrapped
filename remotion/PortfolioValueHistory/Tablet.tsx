...
import { PortfolioValueHistory } from "./PortfolioValueHistory";
...
export const Tablet: React.FC<
  ComponentProps<typeof PortfolioValueHistory> & z.infer<typeof tableSchema>
> = ({ portfolioValueHistory, enterProgress, topTradingDay, topTradingHour }) => {
