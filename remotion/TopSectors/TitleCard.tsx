...
import { TopSectorsTitle } from "./TopSectorsTitle";

export const topSectorsTitleCardSchema = z.object({
...
export const TopSectorsTitleCard: React.FC<
  z.infer<typeof topSectorsTitleCardSchema>
> = ({
  pluralizeLanguages,
  rocket,
  randomizePlanetSeed,
      ...
      >
        ...
        <Sequence from={30} style={{ transform: `translateY(-300px)` }}>
          <AbsoluteFill style={{ marginTop: 100, marginLeft: 300 }}>
            <TopSectorsRocket rocket={rocket} />
          </AbsoluteFill>
        </Sequence>
        <AbsoluteFill
          style={{
