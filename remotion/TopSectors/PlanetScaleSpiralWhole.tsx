...
import { z } from "zod";
import { sectorSchema, rocketSchema } from "../../src/config";
  ...
  rocket,
    ...
    return (
      <AbsoluteFill>
        ...
        >
          <SectorPlanet planetInfo={planetInfo} style={{ width: 400 }} />
        </AbsoluteFill>
        <RocketFront
          rocket={rocket}
          style={{
            transform: `translateX(${currentPosition.offset.x - TL_ROCKET_WIDTH / 2
              }px) translateY(${currentPosition.offset.y - TL_ROCKET_HEIGHT / 2
